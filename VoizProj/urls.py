...
urlpatterns = [
    ...
    path('invoice/',views.invoice_home, name ="invoice"),
    path('invoicenum/',views.invoicenum, name ="invoicenum"),
    path('invoice1/',views.invoice1, name ="invoice"),
    path('adminhome/',views.adminhome, name ="adminhome"),
    path('update/<int:id>', views.preupdate, name="update"),
    path('delete/<int:id>', views.predelete, name="delete"),
    path('new', views.new, name="new"),
    path('postupdate/<int:id>', views.postupdate, name="postupdate"),
    path('postdelete/<int:id>', views.postdelete, name="delete"),
    path('postnew', views.postnew, name="new"),
    path('dongleupdate/<int:id>', views.dongleupdate, name="postupdate"),
    path('dongledelete/<int:id>', views.dongledelete, name="delete"),
    path('donglenew', views.donglenew, name="new"),
]
